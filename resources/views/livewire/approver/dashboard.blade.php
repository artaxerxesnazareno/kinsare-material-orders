            ...
            <div class="flex items-center justify-between">
                ...
                <div class="text-right">
                    ...
                    @if($availableBalance < 1000)
                        <span
                            class="inline-flex items-center rounded-full bg-red-50 px-2.5 py-0.5 text-xs font-medium text-red-800 ring-1 ring-inset ring-red-600/20">
                        Saldo Baixo
                    </span>
                    @endif
                </div>
            ...
            <div class="bg-white rounded-xl shadow-sm border border-neutral-200 p-6">
                <div class="flex items-center">
                    ...
                    <div class="ml-4">
                        ...
                        <p class="text-sm text-neutral-500">{{ $orders->where('status', 'in_review')->count() }}
                            pedidos</p>
                    </div>
                </div>
            </div>
            ...
            <div class="bg-white rounded-xl shadow-sm border border-neutral-200 p-6">
                <div class="flex items-center">
                    ...
                    <div class="ml-4">
                        ...
                        <p class="text-sm text-neutral-500">{{ $orders->where('status', 'approved')->count() }}
                            pedidos</p>
                    </div>
                </div>
            </div>
            ...
            <div class="bg-white rounded-xl shadow-sm border border-neutral-200 p-6">
                <div class="flex items-center">
                    ...
                    <div class="ml-4">
                        ...
                        <p class="text-sm text-neutral-500">{{ $orders->where('status', 'rejected')->count() }}
                            pedidos</p>
                    </div>
                </div>
            </div>
            ...
            <div class="p-6">
                ...
                @if($search || $status)
                    <div class="mt-4 flex items-center gap-2 flex-wrap">
                        @if($search)
                            <span
                                class="inline-flex items-center gap-x-1 rounded-md bg-primary-50 px-2 py-1 text-xs font-medium text-primary-700 ring-1 ring-inset ring-primary-600/20">
                            <span>Busca: {{ $search }}</span>
                            <button type="button" wire:click="$set('search', '')"
                                    class="group relative -mr-1 h-3.5 w-3.5 rounded-sm hover:bg-primary-600/20">
                                <span class="sr-only">Remover</span>
                                <svg viewBox="0 0 14 14"
                                     class="h-3.5 w-3.5 stroke-primary-700/50 group-hover:stroke-primary-700/75">
            ...
            <div class="overflow-x-auto">
                <table class="min-w-full divide-y divide-neutral-200">
                    ...
                    <tr class="bg-neutral-50/80">
                        ...
                        <th scope="col" class="px-6 py-4 text-left">
                            <span
                                class="text-xs font-semibold text-neutral-600 uppercase tracking-wider">Solicitante</span>
                        </th>
                        <th scope="col" class="px-6 py-4 text-left">
                        ...
                        <tr class="group hover:bg-neutral-50/80 transition-all duration-150">
                            <td class="px-6 py-4 whitespace-nowrap">
                                <div class="flex items-center gap-x-3">
                                    <div
                                        class="flex-shrink-0 h-10 w-10 rounded-lg bg-primary-50 flex items-center justify-center">
                                        <span
                                            class="text-sm font-semibold text-primary-700">#{{ substr($order->code, -3) }}</span>
                                    </div>
                                    <div>
                            ...
                            <td class="px-6 py-4 whitespace-nowrap">
                                <span class="status-badge status-badge-{{ $order->status }} shadow-sm">
                                    @switch($order->status)
                                        @case('new')
                                            <span
                                                class="h-2 w-2 flex-shrink-0 rounded-full bg-yellow-400 animate-pulse"></span>
                                            <span>Novo</span>
                                            @break
                                        @case('in_review')
                                            <span
                                        ...
                                        @default
                                            <span
                                                class="h-2 w-2 flex-shrink-0 rounded-full bg-purple-400 animate-pulse"></span>
                            ...
                            <td class="px-6 py-4 whitespace-nowrap">
                                <div class="flex flex-col">
                                    <span
                                        class="text-sm text-neutral-900">{{ $order->created_at->format('d/m/Y') }}</span>
                                    <span
                                        class="text-xs text-neutral-500">{{ $order->created_at->format('H:i') }}</span>
                                </div>
                            </td>
                            <td class="px-6 py-4 whitespace-nowrap">
