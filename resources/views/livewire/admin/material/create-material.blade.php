    ...
    <form wire:submit.prevent="save" class="space-y-6">
        ...
        <div>
            <label for="description" class="block text-sm font-medium text-neutral-700">
                Descrição
                <span class="text-neutral-500 text-xs">(opcional)</span>
            </label>
            <div class="mt-1">
                <textarea id="description"
                          ...
                          rows="3"
                          class="block w-full rounded-lg border-neutral-300 shadow-sm focus:ring-2 focus:ring-primary-500 focus:border-primary-500 text-sm"
                          placeholder="Digite uma descrição para o material"></textarea>
            </div>
            @error('description')
                <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
            @enderror
        ...
        <div class="flex justify-end gap-x-3">
            ...
            <button type="submit"
                ...
                <span wire:loading.remove wire:target="save">Criar Material</span>
